...
from EsproMusic import BOT_USERNAME, app, Esprodb, pytgcalls
from EsproMusic.Helpers import _clear_, admin_check, buttons, close_key, gen_thumb
...
async def skip_str(_, message: Message):
    try:
        ...
        pass
    get = Esprodb.get(message.chat.id)
    if not get:
        try:
